...
export const defaultMessages = [
  {
    ...
    subject: '[Hire Proposal: Full-Stack Web App] $3,000 - $8,000',
    message: 'We are looking for a senior software engineer to help build our next-generation SaaS dashboard using Next.js. Are you available for a contract role starting next month?',
  ...
  },
  {
    ...
    source: 'contact',
    subject: 'Question from Portfolio',
    message: 'Hey John! Loved your 3D interactive hero canvas. Wanted to ask if you have any open-source tutorials on Three.js particle shaders. Keep up the awesome work!',
